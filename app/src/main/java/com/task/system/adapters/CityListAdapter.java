...
import com.task.system.utils.PinyinUtils;
...
//        mCities.add(1, new City("热门", "1"));
                ...
                container.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (locateState == LocateState.FAILED){
                            ...
                            //返回定位城市
                            if (onCityClickListener != null){
                                onCityClickListener.onCityNameClick(locatedCity);
                            }
                        }
                    }
                });
    ...
    public void setNewData(List<CityInfo> cityInfos) {
        this.mCities= cityInfos;
        this.mCities.add(0, new CityInfo("定位", "0"));
        notifyDataSetChanged();
    }
    ...
    public interface OnCityClickListener{
        ...
        void onCityNameClick(String name);
        void onLocateClick();
    }
}