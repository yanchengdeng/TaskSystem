...
//
//    public class HomeFragemntOld extends Fragment {
//
...
//                    com.task.system.fragments.HomeFragment.this.startActivityForResult(new Intent(getContext(), CityListActivity.class), 200);
//                    break;
