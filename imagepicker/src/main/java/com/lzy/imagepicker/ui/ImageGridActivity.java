...
import static com.lzy.imagepicker.R.id.tv_des;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    public static final int REQUEST_PERMISSION_WRITE = 0x03;
...
//    private View mllDir; //文件夹切换按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!(checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE))) {
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, ImageGridActivity.REQUEST_PERMISSION_STORAGE);
        }
        if (!(checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE))) {
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, ImageGridActivity.REQUEST_PERMISSION_WRITE);
        }
        ...
        if (data != null && data.getExtras() != null) {
            ...
            if (directPhoto) {
                if (requestCamera(ImageGridActivity.this)) {
...
//        mllDir.setOnClickListener(this);
        mtvDir = (TextView) findViewById(R.id.tv_des);
        mtvDir.setOnClickListener(this);
        mtvDir.setCompoundDrawablesWithIntrinsicBounds(null,null,getResources().getDrawable(R.mipmap.camera_dowm),null);
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
    ...
    private boolean requestCamera(Activity activity){
        if (afterM()){
            ...
            if ((activity.checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) permissionsList.add(Manifest.permission.READ_EXTERNAL_STORAGE);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE || requestCode == REQUEST_PERMISSION_WRITE) {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            if (mFolderPopupWindow.isShowing()) {
                ...
                mFolderPopupWindow.showAtLocation(topBar, Gravity.NO_GRAVITY, 0, 0);
                //默认选择当前选择的上一个，当目录很多时，直接定位到已选中的条目
                int index = mImageFolderAdapter.getSelectIndex();
                index = index == 0 ? index : index - 1;
                mFolderPopupWindow.setSelection(index);
                mtvDir.setCompoundDrawablesWithIntrinsicBounds(null,null,getResources().getDrawable(R.mipmap.camera_up),null);
            }
...
//                    mImageGridAdapter.refreshData(imageFolder.images);
        ...
        mFolderPopupWindow.setMargin(topBar.getHeight()+2);
    ...
    @Override
    public void onImagesLoaded(List<ImageFolder> imageFold) {
        if (imageFold!=null && imageFold.size()>0) {
            this.mImageFolders = imageFold;
        }
...
//            mImageGridAdapter.refreshData(imageFolders.get(0).images);
            mRecyclerAdapter.refreshData(mImageFolders.get(0).images);
        }
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        if (imagePicker.getSelectImageCount() > 0) {
            ...
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.color_tittle));
            ...
            mBtnPre.setTextColor(ContextCompat.getColor(this, R.color.color_info));
